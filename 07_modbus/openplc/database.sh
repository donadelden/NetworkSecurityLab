...
SQL_PROGRAM="INSERT INTO Programs (Name, Description, File, Date_upload) VALUES ('Traffic Lights', 'A code to run a traffic light in a plc.', 'script.st', strftime('%s', 'now'));"
